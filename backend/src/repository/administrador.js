...
const controller = __importStar(require("../controllers/administrador.controller"));
const administradorRoutes = (0, express_1.Router)();
...
exports.default = administradorRoutes;
